...
void conkyrc_default () {
  ...
  if (set_network == True) {
    ...
    fprintf(fp,"# |--ENP7S0F5%d\n", eth);
    fprintf(fp,"${else}${if_up enp7s0f5%d}\n", eth);
    fprintf(fp,"${voffset -5}${color0}${font ConkyColors:size=15}s${font}${color}${goto %d}${voffset -12}%s: ${font Liberation Sans:style=Bold:size=8}${color1}${upspeed enp7s0f5%d}${color}${font} ${alignr}${color2}${upspeedgraph  enp7s0f5%d 8,60 %s}${color}\n", go2, up, eth, eth, color4);
    fprintf(fp,"${goto %d}%s: ${font Liberation Sans:style=Bold:size=8}${color2}${totalup enp7s0f5%d}${color}${font}\n", go2, total, eth);
    fprintf(fp,"${voffset 2}${color0}${font ConkyColors:size=15}t${font}${color}${goto %d}${voffset -12}%s: ${font Liberation Sans:style=Bold:size=8}${color1}${downspeed enp7s0f5%d}${color}${font} ${alignr}${color2}${downspeedgraph enp7s0f5%d 8,60 %s}${color}\n", go2, down, eth, eth, color4);
    fprintf(fp,"${goto %d}%s: ${font Liberation Sans:style=Bold:size=8}${color2}${totaldown enp7s0f5%d}${color}${font}\n", go2, total, eth); 
    fprintf(fp,"${voffset 4}${color0}${font ConkyColors:size=15}B${font}${color}${goto %d}${voffset -6}%s: ${alignr}${color2}${addr enp7s0f5%d}${color}\n", go2, localip, eth);
    fprintf(fp,"# |--PPP%d\n", ppp);
